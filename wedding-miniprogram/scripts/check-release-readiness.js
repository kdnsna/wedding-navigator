...
function checkFriendsInvitationIteration() {
  ...
  assertIncludes('pages/poster/index.vue', 'transform: scale(0.62)', 'poster page must scale the full poster into the phone viewport')
  assertIncludes('pages/poster/index.vue', 'savePosterCanvasToAlbum', 'poster page must use the robust album save helper')
  assertIncludes('pages-owner/poster/index.vue', 'transform: scale(0.62)', 'owner poster page must scale the full poster into the phone viewport')
