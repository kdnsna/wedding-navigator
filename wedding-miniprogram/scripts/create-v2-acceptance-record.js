...
| 项目 | 结果 | 证据路径/截图编号 | 备注 |
| --- | --- | --- | --- |
| 四色情绪色随机切换，无第五种彩色 | 待测 |  | wine/cinnabar/indigo/pine |
| 宾客端从扉页滑到卷尾，整体像请柬 | 待测 |  | 记录完整录屏 |
| 扉页照片满幅且底部纸色渐变收边 | 待测 |  | 文字不得压脸 |
| 内页照片白边、发丝线、展签完整 | 待测 |  | 首页预览和相册页都看 |
| 旧 theme=sakura-pink 数据打开为酒红且无报错 | 待测 |  | 填写真实 weddingId |
| 四幕向导一气呵成 | 待测 |  | 具名 -> 择地 -> 选照 -> 定色 |
| 第三幕选照立即看到装裱预览 | 待测 |  | 最多九张 |
| 主人端高级色权益状态生效 | 待测 |  | cinnabar/indigo/pine |
